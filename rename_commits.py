...
# Diccionario de reemplazos exactos
replacements = {
...
with open("msg-filter.py", "w", encoding="utf-8") as f:
    f.write('''import sys
...
print(run('git filter-branch -f --msg-filter "python msg-filter.py" HEAD~15..HEAD'))

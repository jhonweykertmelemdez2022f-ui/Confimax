...
// Inyectar path de módulos compartidos
process.env.SHARED_MODULES_PATH = path.join(__dirname, '../../shared');

// Configuración manual de config
const config = require('./config');
config.sharedPath = path.join(__dirname, '../../shared');
